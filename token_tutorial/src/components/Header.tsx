  ...
  return (
    <div className="flex items-center justify-between p-3 shadow-xl shadow-black">
      ...
      >
        ...
        <div className="text-3xl font-bold">Nodit Token Tutorial</div>
      </div>
      <div className="flex items-center justify-between p-3 w-full max-w-2xl">
        ...
        />
        <button
          className="ml-3 rounded-lg bg-noditGreen p-2 transition duration-300 ease-in-out hover:text-white hover:bg-noditGreenDeep font-bold"
