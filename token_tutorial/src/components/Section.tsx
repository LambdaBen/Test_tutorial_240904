  ...
  return (
    <>
      <section className="p-3 mt-5  shadow-xl shadow-black flex flex-col items-center justify-center">
        ...
        <div className="mt-10">
          <p className="text-3xl font-bold"> Token Tutorial Steps 🚀</p>
          <p className="mt-5">
            1. Input your EOA address and click to search EOA Address
          </p>
          <p className="mt-5">
            2. Select the Token what you want to watch more detail
          </p>
          <p className="mt-5">
          ...
          <a
            ...
            href="https://developer.nodit.io/reference/gettokensownedbyaccount"
          >
            👉 If you want to know more about{" "}
            <span className="text-noditGreen">Nodit</span> Token API Click here
            👈
          </a>
        </div>
      </section>
